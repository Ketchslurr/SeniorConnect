    ...
    if (!$user) {
        ...
        if ($stmt->execute([$verificationCode, $user['userId']])) {
            ...
            try {
                ...
                $mail->AltBody = "Hello {$user['fname']}, Please verify your email by clicking the link: http://seniorconnect-production.up.railway.app/views/verifyEmail.php?code=$verificationCode or manually enter this code: $verificationCode";

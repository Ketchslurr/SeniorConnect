...
function getSpecializationDropdown() {
    ...
    <select name="specialization" class="w-full border p-2 rounded">
        ...
        <option value="Pediatric Allergist">Pediatric Allergist</option>
        ...
        <option value="Pediatric Infectious Disease Specialist">Pediatric Infectious Disease Specialist</option>
